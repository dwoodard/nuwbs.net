	...
	<body style="padding:30px;">
		...
		<div class="wizard" id="meida-cloud-setup">
			...
			<div class="wizard-card" data-onValidated="setServerName" data-cardname="name">
				<h3>Welcome to NUWBS</h3>
				<div class="wizard-input-section">
					<p>
						Welcome to NUWBS this wizard will guide you through the installation and configuration.
					</p>
					...
					<div class="control-group">
						...
						<div class="row">
							...
							<div class="span1">
								...
								<input style="width:125px;" type="text" name="database" placeholder="media" value="nuwbs" />
							</div>
						</div>
						<div class="row">
							<div class="span3">
				...
				<div class="wizard-input-section">
					...
					<div class="control-group">
						<select name='queue' class="chzn-select">
							...
							<option selected value="iron">IronIO</option>
					...
					<div id="queue-iron" class="control-group ">
						<div class="row">
							<div class="span3">
